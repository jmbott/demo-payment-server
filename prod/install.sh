...
printf "========================================\n"
$CURL -L https://raw.githubusercontent.com/jmbott/demo-payment-server/0.0.2/prod/docker-compose.yml > docker-compose.yml
$CURL -L https://raw.githubusercontent.com/jmbott/demo-payment-server/0.0.2/prod/nginx.conf > nginx.conf
