#!/usr/bin/env sh
# Demo Payment Server installer for version 0.0.4
set -e
...
printf "========================================\n"
$CURL -L https://raw.githubusercontent.com/jmb2341/demo-payment-server/0.0.4/prod/docker-compose.yml > docker-compose.yml
$CURL -L https://raw.githubusercontent.com/jmb2341/demo-payment-server/0.0.4/prod/nginx.conf > nginx.conf
